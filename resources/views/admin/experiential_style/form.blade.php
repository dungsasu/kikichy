...
@php
    $title = (@$data->id ? 'Chi tiết' : 'Thêm') . ' ' . 'phong cách trải nghiệm';
@endphp
@section('title', $title)
...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="mt-4 mb-4">
            ...
            <button type="reset" onclick="window.location.href='{{ route('admin.experiential_style.index') }}'"
        ...
        <div class="card-body pt-2 mt-1">
            ...
            <div class="tab-content p-0">
                <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                    @include('admin.experiential_style.info')
                </div>
