<form id="formAccountSettings" method="POST" action={{ route('admin.experiential_style.save') }} enctype="multipart/form-data">
    ...
    <div class="row mt-2 gy-4">
        <div class="col-md-6">
            <div class="form-floating form-floating-outline">
                ...
                <label for="firstName">Tên phong cách trải nghiệm</label>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-floating form-floating-outline">
