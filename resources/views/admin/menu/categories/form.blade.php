...
@section('content')
    <div class="row">
        <div class="d-flex justify-content-between">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light"></span> Danh mục Menu
            </h4>
            <div class="mt-4 mb-4">
                ...
                <button type="submit" id="submit3" class="btn btn-primary me-2">Lưu & Thoát</button>                <button type="reset" onclick="window.location.href='{{route('admin.menu.categories.index')}}'" class="btn btn-outline-secondary">Đóng</button>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body pt-2 mt-1">
                    <form action={{ route('admin.menu.categories.save') }} id="formAccountSettings" method="POST"
