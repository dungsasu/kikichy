...
@endphp
    <div class="row gy-4">
        @if (@$show_button_action)
            ...
            create="{{ route('create_news-categories') }}"
            :model="$model"
            />
        @endif
        <div class="col-12">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a style="width: 30px" class="dropdown-item p-1"
                                            href="{{ route('edit_news-categories', ['id' => $item->id]) }}">
                                            <i class="mdi mdi-pencil-outline me-1"></i>
                                        </a>
                                        <a style="width: 30px" class="dropdown-item p-1 delete-record"
                                            data-link="{{ route('delete_news-categories', ['id' => $item->id, 'agreeDelete' => $item->id, 'route' => 'admin.news.categories.index']) }}">
