...
@section('content')
    ...
    <div class="row gy-4">
        @if (@$show_button_action)
            <x-button-action show="create,duplicate,active,unactive,delete" create="{{ route('admin.tour-types.create') }}" :model="$model" />
        @endif
        <div class="col-12">
            <div class="card">
                        ...
                        <tbody>
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.tour-types.edit', ['id' => $item->id]) }}" class="d-flex align-items-center">
                                            <div>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a style="width: 30px" class="dropdown-item p-1"
                                                href="{{ route('admin.tour-types.edit', ['id' => $item->id]) }}">
                                                <i class="mdi mdi-pencil-outline me-1"></i>
                                            </a>
                                            <a style="width: 30px" class="dropdown-item p-1 delete-record"
                                                data-link="{{ route('admin.tour-types.delete', ['id' => $item->id, 'agreeDelete' => $item->id, 'route' => 'admin.tour-types.index']) }}">
