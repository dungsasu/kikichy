...
@section('content')
    ...
    <div class="row gy-4">
        @if (@$show_button_action)
            <x-button-action show="create,duplicate,active,unactive,delete" create="{{ route('admin.instructions.create') }}" :model="$model" />
        @endif
        <div class="col-12">
            <div class="card">
                    ...
                    <table class="table">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-truncate">Tên loại hướng dẫn</th>
                        ...
                        <tbody>
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.instructions.edit', ['id' => $item->id]) }}" class="d-flex align-items-center">
                                            <div>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a style="width: 30px" class="dropdown-item p-1"
                                                href="{{ route('admin.instructions.edit', ['id' => $item->id]) }}">
                                                <i class="mdi mdi-pencil-outline me-1"></i>
                                            </a>
                                            <a style="width: 30px" class="dropdown-item p-1 delete-record"
                                                data-link="{{ route('admin.instructions.delete', ['id' => $item->id, 'agreeDelete' => $item->id, 'route' => 'admin.instructions.index']) }}">
