...
@section('content')
    ...
    <div class="row gy-4">
        <x-button-action show="create,duplicate,active,unactive,delete"
            create="{{ route('admin.contents.categories.create') }}" :model="$model" :view="$view" />
        <div class="col-12">
            <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a style="width: 30px" class="dropdown-item p-1"
                                            href="{{ route('admin.contents.categories.edit', ['id' => $item->id]) }}">
                                            <i class="mdi mdi-pencil-outline me-1"></i>
                                        </a>
                                        <a style="width: 30px" class="dropdown-item p-1 delete-record"
                                            data-link="{{ route('admin.contents.categories.delete', ['id' => $item->id, 'agreeDelete' => $item->id, 'route' => 'admin.contents.categories.index']) }}">
