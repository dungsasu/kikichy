...
@section('content')
    ...
    <div class="row gy-4">
        @if (@$show_button_action)
            <x-button-action show="create,duplicate,active,unactive,delete" 
                        ...
                        <tbody>
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{-- <a target="_blank" href="{{ route('client.contents-detail', ['category' => @$item->category->alias, 'alias' => $item->alias]) }}"> --}}
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a style="width: 30px" class="dropdown-item p-1"
                                                href="{{ route('admin.contents.edit', ['id' => $item->id]) }}">
                                                <i class="mdi mdi-pencil-outline me-1"></i>
                                            </a>
                                            <a style="width: 30px" class="dropdown-item p-1 delete-record"
                                                data-link="{{ route('admin.contents.delete', ['id' => $item->id, 'agreeDelete' => $item->id, 'route' => 'admin.contents.index']) }}">
