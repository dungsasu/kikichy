...
@section('content')
    ...
    <div class="row gy-4">
        @if (@$show_button_action)
            <x-button-action show="create,duplicate,active,unactive,delete" create="{{ route('admin.news.create') }}" :model="$model" />
        @endif
                        ...
                        <tbody>
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.news.edit', ['id' => $item->id]) }}" class="d-flex align-items-center">
                                    ...
                                    <td>
                                        <a target="_blank" href="{{ route('client.news-detail', ['category' => @$item->category->alias, 'alias' => $item->alias]) }}">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a style="width: 30px" class="dropdown-item p-1 delete-record"
                                                data-link="{{ route('delete_news', ['id' => $item->id, 'agreeDelete' => $item->id, 'route' => 'admin.news.index']) }}">
