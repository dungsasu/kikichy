...
@php
    $title = (@$data->id ? 'Chi tiết' : 'Thêm') . ' ' . 'kích thước';
@endphp
@section('title', $title)
...
@section('content')
    <div class="row">
        <div class="d-flex justify-content-between">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light"></span> {{ @$data->id ? 'Chi tiết' : 'Thêm' }} kích thước
            </h4>
            <div class="mt-4 mb-4">
                ...
                <button type="button" onclick="window.location.href='{{ route($view . '.index') }}'"
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body pt-2 mt-1">
                    <form action={{ route('save_size') }} id="formAccountSettings" method="POST"
