    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <button type="reset" class="btn btn-outline-secondary"
                onclick="window.location.href = '{{ route('admin.gallery.index') }}'">Đóng</button>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body pt-2 mt-1">
                    <form action={{ route('save_gallery') }} id="formAccountSettings" method="POST"
                        ...
                        <div class="row mt-2 gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <select id="selectTypeOpt" name="category_id"
                                        class="form-select color-dropdown select2">
                    ...
                    <x-gallery name="gallery" href :data-component="@$data->images" field="url" type="Videos">
                    </x-gallery>
                </div>
                <!-- /Account -->
            </div>
