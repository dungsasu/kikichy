                ...
                <div class="card-body pt-2 mt-1">
                    <form action={{ route($view.'.save') }} id="formAccountSettings" method="POST"
                        ...
                        <div class="row mt-2 gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input class="form-control" type="text" id="ratio" name="ratio" value="{{ @$data->ratio }}"
                                        placeholder="16:9" />
                                    <label for="ratio">Tỉ lệ Ảnh</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <select name="product_category_id" class="form-select select2 form-select-sm">
                                        ...
                                        @foreach ($productCategories as $category)
                                            @if (@$data->product_category_id == $category->id && @$data->id)
                                                <option
                                                    {{ @$data->product_category_id == $category->id && @$data->id ? 'selected' : null }}
