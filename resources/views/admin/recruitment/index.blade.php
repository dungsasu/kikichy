...
@section('content')
    ...
    <div class="row gy-4">
        @if (@$show_button_action)
            <x-button-action show="create,duplicate,active,unactive,delete" create="{{ route($view . '.create') }}" :model="$model" />
        @endif
        <div class="col-12">
            <div class="card">
                        ...
                        <tbody>
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route($view . '.edit', ['id' => $item->id]) }}" class="d-flex align-items-center">
