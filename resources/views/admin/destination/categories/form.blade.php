...
@php
    $title = (@$data->id ? 'Chi tiết' : 'Thêm') . ' ' . 'danh mục điểm đến';
@endphp
@section('title', $title)
    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body pt-2 mt-1">
                <form action={{ route('admin.destination.categories.save') }} id="formAccountSettings" method="POST"
                    ...
                    <div class="row mt-2 gy-4">
                        ...
                        <div class="col-md-6">
                            <x-choose-file title="Thay ảnh" :type="'Images'" id="image" :dataComponent="@$data"
                                field="image" />
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
