...
@section('title', 'Danh mục điểm đến')
...
@endphp
    <div class="row gy-4">
        @if (@$show_button_action)
            ...
            create="{{ route('admin.destination.categories.create') }}"
            :model="$model"
            />
        @endif
        <div class="col-12">
                    ...
                    <table class="table">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-truncate">Tên danh mục điểm đến</th>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a style="width: 30px" class="dropdown-item p-1"
                                            href="{{ route('admin.destination.categories.edit', ['id' => $item->id]) }}">
                                            <i class="mdi mdi-pencil-outline me-1"></i>
                                        </a>
                                        <a style="width: 30px" class="dropdown-item p-1 delete-record"
                                            data-link="{{ route('admin.destination.categories.delete', ['id' => $item->id, 'agreeDelete' => $item->id, 'route' => 'admin.destination.categories.index']) }}">
