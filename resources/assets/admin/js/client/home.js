$(document).ready(function () {
    ...
    $(".carousel_banner_mobile").owlCarousel({
        // loop: true,
        nav: true,
        items: 1,
        loop: true,
    ...
    $(".carousel_video_mobile").owlCarousel({
        // loop: true,
        nav: true,
        items: 1,
        loop: true,
        ...
        navText: [
            `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="40" height="40" rx="20" transform="matrix(-1 0 0 1 40 0)" fill="rgba(0, 0, 0, 0.24)"/>
        <path d="M22 24L18 20L22 16" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        `,
            `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_2001_3022)">
        <rect width="40" height="40" rx="20" fill="rgba(0, 0, 0, 0.24)"/>
        <path d="M18 24L22 20L18 16" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
        <defs>
        <clipPath id="clip0_2001_3022">
    ...
    $("#customer_dmc").owlCarousel({
        ...
        navText: [
            `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="40" height="40" rx="20" transform="matrix(-1 0 0 1 40 0)" fill="rgba(0, 0, 0, 0.24)"/>
        <path d="M22 24L18 20L22 16" stroke="rgba(255,2555,255,1)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        `,
            `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_2001_3022)">
        <rect width="40" height="40" rx="20" fill="rgba(0, 0, 0, 0.24)"/>
        <path d="M18 24L22 20L18 16" stroke="rgba(255,2555,255,1)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
        <defs>
        <clipPath id="clip0_2001_3022">
        <rect width="40" height="40" rx="20" fill="white"/>
    ...
    $(".event_click_btn_buy").on("click", function (event) {
        event.preventDefault(); // Ngăn chặn việc điều hướng liên kết
        // Thực hiện các hành động khác khi nhấp vào .event_click_btn_buy
    });
});
