...
function MenuEditor(idSelector, options) {
    ...
    var settings = {
        ...
        textConfirmDelete: 'Mục này sẽ bị xoá, bạn có chắc chắn muốn xoá?',
    ...
    $main.on('click', '.btnRemove', function (e) {
        ...
        Swal.fire({
            title: 'Thông báo!',
            text: settings.textConfirmDelete,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Đồng ý xoá',
            cancelButtonText: 'Tôi muốn xem lại',
            customClass: {
    ...
    function createMenu(arrayItem, depth) {
        ...
        $.each(arrayItem, function (k, v) {
            ...
            var itemObject = { text: "", href: "", icon: "empty", target: "_self", title: "", published: "", image: "" };
            var temp = $.extend({}, v);
            if (isParent) {
