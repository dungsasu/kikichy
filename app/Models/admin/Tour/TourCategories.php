...
class TourCategories extends Model
{
    ...
    {
        return $this->alias ? route('client.tour-categories', ['alias' => $this->alias]) : null;
    }

    public function filter_table()
    {
        return $this->belongsTo(FilterTableModel::class, 'filter_table_id');
    }

    public function tours() {
        return $this->hasMany(TourModel::class, 'category_id', 'id');
    }

    public function children()
    {
        return $this->hasMany(TourCategories::class, 'parent_id');
    }

    public function parent()
    {
        return $this->belongsTo(TourCategories::class, 'parent_id');
    }

    public function ancestors() {
        return $this->parentCategory()->with('ancestors');
    }
