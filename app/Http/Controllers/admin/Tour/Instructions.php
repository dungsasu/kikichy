...
use App\Models\admin\Tour\Instructions as InstructionsModel;

class Instructions extends BaseController
{
    public function __construct()
    {
        $this->model = InstructionsModel::class;
        $this->view = 'admin.instructions';
    ...
    {
        return ['admin.instructions.create', 'admin.instructions.edit', 'admin.instructions.index'];
    }
